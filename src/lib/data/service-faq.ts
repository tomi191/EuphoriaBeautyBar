...
export const SERVICE_FAQ: Record<string, Array<{ question: string; answer: string }>> = {
  "frizorski-uslugi": [
    ...
    { question: "Правите ли мъжко подстригване и мъжки прически?", answer: "Да, мъжкото подстригване и оформянето на мъжки прически са сред редовните ни услуги, заедно с дамско подстригване, боядисване и балаяж." },
  ],
  "frizorski-terapii": [
  ...
  "manikyur-i-pedikyur": [
    ...
    { question: "Правите ли френски маникюр?", answer: "Да — френски маникюр и омбре дизайн се правят към маникюра с гел лак, включително върху къси нокти. Кажи желания дизайн при записването." },
    { question: "Мога ли да запазя час за маникюр онлайн?", answer: "Най-бързо през euphoriabeauty.eu/zapazi-chas — ако за маникюра в момента няма активен онлайн график, формата показва телефон, на който запазваш веднага." },
  ],
  kozmetika: [
    { question: "Какво е Hydrafacial?", answer: "Модерно дълбоко почистване, което едновременно хидратира и ексфолира кожата — подходящо за освежаване и хидратация." },
    { question: "Правите ли кола маска?", answer: "Да — кола маска за цели или половин крака, ръце, подмишници и горна устна, плюс оформяне и боядисване на вежди. Лазерна епилация не предлагаме." },
...
export const SERVICE_INTRO: Record<string, string[]> = {
  ...
  "manikyur-i-pedikyur": [
    ...
    "Гел лакът обикновено издържа 2–3 седмици; препоръчваме нова процедура при израстване, не по-късно, за да остане ноктът здрав. Медицинският педикюр е за конкретни проблеми — врастнал нокът, мазоли, напукани пети — и се различава от козметичния. Салонът е на ул. Петър Райчев 18, кв. Левски, Варна. Час за маникюр запазваш на euphoriabeauty.eu/zapazi-chas или по телефона на салона.",
  ],
  kozmetika: [
