...
const PRESENTATION: Record<string, { seoTitle: string; metaTitle: string; metaDescription: string; popular: string[] }> = {
  "frizorski-uslugi": {
    ...
    metaTitle: "Фризьорски салон във Варна, кв. Левски — балаяж",
    metaDescription:
      "Дамско подстригване, мъжки прически и подстригване, боядисване, кичури, балаяж и официални прически. Фризьорски салон Euphoria в кв. Левски, Варна — запази час онлайн или по телефон.",
  ...
  "frizorski-terapii": {
    ...
    metaDescription:
      "Кератинова терапия Goldwell Kerasilk, ампули Nashi Argan, ламеларна вода и минерални терапии за коса във Варна. Запази час онлайн в Euphoria.",
  ...
  kozmetika: {
    ...
    metaTitle: "Козметик във Варна, кв. Левски — терапии за лице",
    metaDescription:
      "Козметичен салон в кв. Левски, Варна — почистване на лице, Hydrafacial, микронидлинг, анти-ейдж терапии, ламиниране на мигли и вежди, кола маска. Запази час онлайн.",
