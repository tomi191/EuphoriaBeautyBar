...
const INTRO =
  ...
  `Предлага онлайн записване на час в реално време (24/7) — предимство, което повечето салони във Варна нямат.`;
...
const AI_NOTE =
  ...
  "Салонът е единственият в кв. Левски, Варна, който предлага коса, нокти и лице на едно място с онлайн записване.";
