...
/**
 * Реално, ръчно писано съдържание per money услуга — НЕ template/slop (виж spec
 * docs/superpowers/specs + seo-content препоръките). Само услуги с тук съдържание
 * получават отделна страница (shortlist). Останалите остават line items в категорията.
 */
const SERVICE_CONTENT: Record<string, ServiceContent> = {
  "meditsinski-pedikyur": {
    metaTitle: "Медицински педикюр във Варна, кв. Левски — цена и записване | Euphoria",
    metaDescription:
      "Медицински педикюр за вкраснали нокти, мазоли и напукани пети в кв. Левски, Варна. Стерилни инструменти, обучен специалист. От 35 €. Запази час онлайн.",
